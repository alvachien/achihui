...
@Component({
    selector: 'hih-learn-plan-list',
    templateUrl: 'app/views/learn/plan.list.html'
})
export class PlanListComponent implements OnInit, OnDestroy {
    public lrnPlans: Array<HIHLearn.LearnAward>;
    ...
    constructor(
        ...
        if (DebugLogging) {
            console.log("Entering constructor of Learn.PlanListComponent");
        }
    }

    ngOnInit() {
        if (DebugLogging) {
            console.log("Entering ngOnInit of Learn.PlanListComponent");
        }
    ...
    ngOnDestroy() {
        if (DebugLogging) {
            console.log("Entering ngOnDestroy of Learn.PlanListComponent");
        }
    ...
    handleError(error: any) {
        if (DebugLogging) {
            console.log("Entering handleError of Learn.PlanListComponent");
        }
        console.log(error);
