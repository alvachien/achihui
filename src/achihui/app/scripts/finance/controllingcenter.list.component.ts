...
@Component({
    selector: 'hih-fin-cc-list',
    templateUrl: 'app/views/finance/controllingcenter.list.html'
})
export class ControllingCenterListComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        if (DebugLogging) {
            console.log("Entering constructor of ControllingCenterListComponent");
        }
    }

    ngOnInit() {
        if (DebugLogging) {
            console.log("Entering ngOnInit of ControllingCenterListComponent");
        }
    ...
    ngOnDestroy() {
        if (DebugLogging) {
            console.log("Entering ngOnDestroy of ControllingCenterListComponent");
        }
    ...
    getControllingCenterList(data: Array<HIHFinance.ControllingCenter>) {
        if (DebugLogging) {
            console.log("Entering getControllingCenterList of ControllingCenterListComponent");
        }
    ...
    handleError(error: any) {
        if (DebugLogging) {
            console.log("Entering handleError of ControllingCenterListComponent");
        }
        console.log(error);
