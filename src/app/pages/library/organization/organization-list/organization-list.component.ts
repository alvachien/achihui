    ...
    this.modalService.confirm({
      ...
      nzOnOk: () => {
        this.odataService.deleteOrganization(pid).subscribe({
          ...
          error: err => {
            ModelUtility.writeConsoleLog(`AC_HIH_UI [Error]: Entering OrganizationList onDelete failed ${err}`, ConsoleLogTypeEnum.error);
            this.modalService.error({
              nzTitle: translate('Common.Error'),
      ...
      nzCancelText: 'No',
      nzOnCancel: () => ModelUtility.writeConsoleLog(`AC_HIH_UI [Debug]: Entering OrganizationList onDelete cancelled`, ConsoleLogTypeEnum.debug)
    });    
  }
}
