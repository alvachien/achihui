...
describe('AccountDetailComponent', () => {
  ...
  beforeEach(async(() => {
    ...
    const activatedRouteStub = new ActivatedRouteUrlStub([new UrlSegment('create', {})] as UrlSegment[]);
    ...
    const stroageService = jasmine.createSpyObj('FinanceStorageService', ['fetchAllAccountCategories', 'fetchAllAssetCategories']);
    const allAccountCtgySpy = stroageService.fetchAllAccountCategories.and.returnValue(of([]));
    const allAssetCtgySpy = stroageService.fetchAllAssetCategories.and.returnValue(of([]));
