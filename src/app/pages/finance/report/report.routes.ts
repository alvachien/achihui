...
export const REPORT_ROUTES: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./control-center-month-on-month-report/').then((m) => m.ControlCenterMonthOnMonthReportComponent),
  },
  {
    path: 'order',
  ...
  },
  {
    path: 'trantypemom',
    loadComponent: () =>
      import('./tran-type-month-on-month-report/').then((m) => m.TranTypeMonthOnMonthReportComponent),
  },
  {
    path: 'cash',
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./statement-of-income-expense-month-on-month/').then(
        (m) => m.StatementOfIncomeExpenseMonthOnMonthComponent,
      ),
  },
];
