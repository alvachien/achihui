...
export class AccountComponent implements OnInit, OnDestroy {
    constructor(
        ...
        if (DebugLogging) {
            console.log("Entering constructor of AccountComponent");
        }
    }

    ngOnInit() {
        if (DebugLogging) {
            console.log("Entering ngOnInit of AccountComponent");
        }
    }

    ngOnDestroy() {
        if (DebugLogging) {
            console.log("Entering ngOnDestroy of AccountComponent");
        }
    }

    handleError(error: any) {
        if (DebugLogging) {
            console.log("Entering handleError of AccountComponent");
        }
        console.log(error);
