...
describe("AccountExtraAssetComponent", () => {
  ...
  it("shall work with data 2: input category", fakeAsync(() => {
    ...
    const astval2 = testingComponent.formGroup.get("infoControl")
      ?.value as AccountExtraAsset;
  ...
  template: `
    <form [formGroup]="formGroup">
      <hih-finance-account-extra-asset
        ...
        [arAssetCategories]="arAssetCategories"
      ></hih-finance-account-extra-asset>
    </form>
  `,
})
export class FinanceAccountExtraAssetTestFormComponent {
  ...
  @ViewChild(AccountExtraAssetComponent, { static: true }) assetComponent:
    | AccountExtraAssetComponent
    | undefined;
