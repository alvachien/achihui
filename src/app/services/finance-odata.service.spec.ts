...
describe("FinanceOdataService", () => {
  ...
  const accountCategoryAPIURL: any =
    environment.ApiUrl + `/FinanceAccountCategories`;
  ...
  const assetCategoryAPIURL: any =
    environment.ApiUrl + `/FinanceAssetCategories`;
  ...
  describe("fetchAllCurrencies", () => {
    ...
    it("should be OK returning no currencies", () => {
      ...
      service.fetchAllCurrencies().subscribe({
        next: (curries: any) => {
          expect(curries.length)
            .withContext("should have empty currencies array")
            .toEqual(0);
          expect(service.Currencies.length)
    ...
    it("should return expected currencies (called multiple times)", () => {
      ...
      service.fetchAllCurrencies().subscribe({
        next: (curries: any) => {
          ...
          expect(curries.length)
            .withContext("should have buffered")
            .toEqual(service.Currencies.length);
        },
        error: (fail: any) => {
          // Do nothing
        },
  ...
  describe("fetchAllAccountCategories", () => {
    ...
    it("should be OK returning no account categories", () => {
      ...
      service.fetchAllAccountCategories().subscribe({
        next: (data: any) => {
          expect(data.length)
            .withContext("should have empty account categories array")
            .toEqual(0);
          expect(service.AccountCategories.length)
            .withContext("should buffered nothing")
            .toEqual(0);
    ...
    it("should return expected account categories (called multiple times)", () => {
      ...
      service.fetchAllAccountCategories().subscribe({
        next: (data: any) => {
          ...
          expect(data.length)
            .withContext("should have buffered")
            .toEqual(service.AccountCategories.length);
        },
        error: (fail: any) => {
          // Do nothing
        },
  ...
  describe("fetchAllAssetCategories", () => {
    ...
    it("should be OK returning no asset categories", () => {
      ...
      service.fetchAllAssetCategories().subscribe({
        next: (data: any) => {
          expect(data.length)
            .withContext("should have empty asset categories array")
            .toEqual(0);
          expect(service.AssetCategories.length)
            .withContext("should buffered nothing")
            .toEqual(0);
    ...
    it("should return expected asset categories (called multiple times)", () => {
      ...
      service.fetchAllAssetCategories().subscribe({
        next: (data: any) => {
          ...
          expect(data.length)
            .withContext("should have buffered")
            .toEqual(service.AssetCategories.length);
        },
        error: (fail: any) => {
          // Do nothing
        },
  ...
  describe("fetchAllDocTypes", () => {
    ...
    it("should be OK returning no doc types", () => {
      ...
      service.fetchAllDocTypes().subscribe({
        next: (data: any) => {
          expect(data.length)
            .withContext("should have empty doc types array")
            .toEqual(0);
          expect(service.DocumentTypes.length)
            .withContext("should buffered nothing")
            .toEqual(0);
    ...
    it("should return expected doc types (called multiple times)", () => {
      ...
      service.fetchAllDocTypes().subscribe({
        next: (data: any) => {
          ...
          expect(data.length)
            .withContext("should have buffered")
            .toEqual(service.DocumentTypes.length);
        },
        error: (fail: any) => {
          // Do nothing
        },
  ...
  describe("fetchAllTranTypes", () => {
    ...
    it("should be OK returning no tran types", () => {
      ...
      service.fetchAllTranTypes().subscribe({
        next: (data: any) => {
          expect(data.length)
            .withContext("should have empty tran types array")
            .toEqual(0);
          expect(service.TranTypes.length)
            .withContext("should buffered nothing")
            .toEqual(0);
    ...
    it("should return expected tran types (called multiple times)", () => {
      ...
      service.fetchAllTranTypes().subscribe({
        next: (data: any) => {
          ...
          expect(data.length)
            .withContext("should have buffered")
            .toEqual(service.TranTypes.length);
        },
        error: (fail: any) => {
          // Do nothing
        },
      ...
      service.fetchAllTranTypes().subscribe({
        next: (data: any) => {
          expect(data.length)
            .withContext("should return expected tran")
            .toEqual(fakeData.finTranTypesFromAPI.length);
        },
        error: (fail: any) => {
          // Do nothing
  ...
  describe("massCreateNormalDocument", () => {
    ...
    it("should work for normal doc", () => {
      service
        .massCreateNormalDocument([fakeData.finNormalDocumentForCreate])
        .subscribe(
          (data: any) => {
            expect(data).toBeTruthy();
          },
  ...
  describe("createDocumentFromDPTemplate", () => {
    ...
    it("should return doc for success case", () => {
      service
        .createDocumentFromDPTemplate({ DocId: 100 } as TemplateDocADP)
        .subscribe(
          (data: any) => {
            expect(data).toBeTruthy();
          },
  ...
  describe("createADPDocument", () => {
    ...
    it("should return doc for normal doc", () => {
      service
        .createADPDocument(
          fakeData.finADPDocumentForCreate,
          fakeData.finAccountExtraAdvancePayment,
          true
        )
        .subscribe(
          (data: any) => {
    ...
    it("should return doc for normal doc", () => {
      service
        .createAssetBuyinDocument(
          fakeData.buildFinAssetBuyInDocumentForCreate()
        )
        .subscribe(
          (data: any) => {
            expect(data).toBeTruthy();
    ...
    it("should return doc for normal doc", () => {
      service
        .createAssetSoldoutDocument(
          fakeData.buildFinAssetSoldoutDocumentForCreate()
        )
        .subscribe(
          (data: any) => {
            expect(data).toBeTruthy();
    ...
    it("should return doc for normal doc", () => {
      service
        .createAssetValChgDocument(
          fakeData.buildFinAssetValueChangeDocumentForCreate()
        )
        .subscribe(
          (data: any) => {
            expect(data).toBeTruthy();
  ...
  describe("calcADPTmpDocs", () => {
    const calcADPTmpAPIURL: any =
      environment.ApiUrl + "/GetRepeatedDatesWithAmount";
    ...
    it("should return expected ADP temp docs", () => {
      service.calcADPTmpDocs(inputData).subscribe(
        (data: any) => {
          expect(data.length).toEqual(
            outputData.length,
            "should return expected numbers"
          );
        },
        (fail: any) => {
          // Empty
  ...
  describe("getDocumentItemByAccount", () => {
    ...
    it("should return data in success case", () => {
      service
        .getDocumentItemByAccount(21, 100, 100, moment(), moment().add(1, "y"))
        .subscribe(
          (data: any) => {
            expect(data).toBeTruthy();
          },
  ...
  describe("getDocumentItemByOrder", () => {
    ...
    it("should return data in success case", () => {
      service
        .getDocumentItemByOrder(21, 100, 0, moment(), moment().add(1, "y"))
        .subscribe(
          (data: any) => {
            expect(data).toBeTruthy();
          },
