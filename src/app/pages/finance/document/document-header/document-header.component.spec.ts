...
describe("DocumentHeaderComponent", () => {
  ...
  describe("Enable Mode for normal document", () => {
    ...
    it("Tran date is mandatory", fakeAsync(() => {
      ...
      expect(component.headerForm.get("currControl")?.value).toEqual(
    ...
    it("shall show exchange rate for foreign currency", fakeAsync(() => {
      ...
      expect(
        fixture.debugElement.queryAll(By.css("#exgrate_plan")).length
      ).toEqual(0);
    ...
    it("it shall return correct Document object", fakeAsync(() => {
      ...
      component.headerForm
        .get("currControl")
        ?.setValue(fakeData.chosedHome.BaseCurrency);
      fixture.detectChanges();
  ...
  describe("Enable Mode for currency exchange document", () => {
    ...
    it("shall show exchange rate for second foreign currency", fakeAsync(() => {
      ...
      expect(fixture.debugElement.queryAll(By.css("#idexg2")).length).toEqual(
        0
      );
      expect(
        fixture.debugElement.queryAll(By.css("#exgrate_plan2")).length
      ).toEqual(0);
