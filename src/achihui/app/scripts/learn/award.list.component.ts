...
@Component({
    selector: 'hih-learn-award-list',
    templateUrl: 'app/views/learn/award.list.html'
})
export class AwardListComponent implements OnInit, OnDestroy {
    public lrnAwards: Array<HIHLearn.LearnAward>;
    ...
    constructor(
        ...
        if (DebugLogging) {
            console.log("Entering constructor of Learn.AwardListComponent");
        }
    }

    ngOnInit() {
        if (DebugLogging) {
            console.log("Entering ngOnInit of Learn.AwardListComponent");
        }
    ...
    ngOnDestroy() {
        if (DebugLogging) {
            console.log("Entering ngOnDestroy of Learn.AwardListComponent");
        }
    ...
    handleError(error: any) {
        if (DebugLogging) {
            console.log("Entering handleError of Learn.AwardListComponent");
        }
        console.log(error);
