...
@NgModule({
  declarations: [PersonListComponent, PersonDetailComponent, PersonSelectionDlgComponent],
  imports: [CommonModule, LibraryUIModule, TranslocoModule, PersonRoutingModule],
})
