...
describe('DocTypeListComponent', () => {
  ...
  beforeAll(() => {
    ...
    storageService = jasmine.createSpyObj('FinanceOdataService', ['fetchAllDocTypes']);
  ...
  beforeEach(waitForAsync(() => {
    ...
    declarations: [MessageDialogComponent, DocTypeListComponent],
    imports: [FormsModule,
        FinanceUIModule,
        ReactiveFormsModule,
        RouterTestingModule,
  ...
  describe('2. shall work with data', () => {
    ...
    it('should show data after OnInit', fakeAsync(() => {
      ...
      expect(component.dataSet.length).toEqual(fakeData.finDocTypes.length);
