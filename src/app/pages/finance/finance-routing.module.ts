...
const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: () => import('./account-reconcile/account-reconcile.module').then((m) => m.AccountReconcileModule),
  },
  {
    path: 'document',
  ...
  },
  {
    path: 'search',
    loadChildren: () =>
      import('./document-item-search/document-item-search.module').then((m) => m.DocumentItemSearchModule),
  },
  {
    path: 'report',
