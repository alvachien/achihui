...
export class OrganizationDetailComponent implements OnInit, OnDestroy {
      ...
      switch (this.uiMode) {
        ...
        case UIMode.Display: {
          ...
          .subscribe({
            ...
            error: err => {
              ModelUtility.writeConsoleLog(`AC_HIH_UI [Error]: Entering OrganizationDetailComponent ngOnInit readOrganization failed ${err}...`,
  ...
  ngOnDestroy() {
    ModelUtility.writeConsoleLog('AC_HIH_UI [Debug]: Entering OrganizationDetailComponent OnDestroy...',
      ConsoleLogTypeEnum.debug);
